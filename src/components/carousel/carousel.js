        ...
        <div>
            <div className="discount">
                ...
                <div className="carousel-inner">
                    ...
                    <img src=".\img\carousel\Carousel-HaceteVIP.png" className="d-block w-100" alt="..." width="300px" height="300px"/>
                    </div>
                    <div className="carousel-item">
                    <img src=".\img\carousel\Carousel-McComunidad.png" className="d-block w-100" alt="..." width="300px" height="300px"/>
                    </div>
                    <div className="carousel-item">
                    <img src=".\img\carousel\Carousel-McDelivery.png" className="d-block w-100" alt="..." width="300px" height="300px"/>
                    </div>
                </div>
